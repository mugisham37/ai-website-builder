export default function SelectedWorks() {
  return (
    <section className="px-4 sm:px-8 md:px-16 lg:px-28 py-12 sm:py-16 md:py-20 bg-white">
          ...
          <div className="flex-1">
            <div className="aspect-[2/1] bg-gray-200 mb-6 sm:mb-8 overflow-hidden rounded-sm">
              <div className="w-full h-full bg-gradient-to-br from-gray-400 to-gray-500 flex items-center justify-center">
                <span className="text-white text-xs sm:text-sm">E-Commerce Platform</span>
              </div>
            </div>
